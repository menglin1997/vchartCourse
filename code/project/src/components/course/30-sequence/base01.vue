...
const spec = {
  ...
  data: [
      ...
      values: [
        {
          ...
          dots: [
            {
              event_time: -2209017943000, // 事件发生时间 时间戳
              node_name: "Deandre Ayton_0_start_node", // 节点名称
              event_type: "start", // 事件类型
            },
            {
    ...
    },
    {
      ...
      values: [
        {
          from: "Deandre Ayton_0_start_node", // 起始节点
          to: "Deandre Ayton_0_end_node", // 结束节点
        },
        {
  ...
  series: [
    {
      ...
      xField: 'event_time',
      yField: 'player_name',
      dotTypeField: 'event_type', // 声明dot系列的事件分组字段 在相同的分组中事件点的颜色相同

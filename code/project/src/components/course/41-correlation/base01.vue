...
onMounted(() => {
  ...
  categoryField: "word", // 节点名称字段配置
  valueField: "sim", // 相关性数据字段配置
  sizeField: "pv", // 尺寸数据字段配置
  sizeRange: [12, 30], // 尺寸范围配置

  // 布局相关配置
  // innerRadius: "50%", // 内半径配置 支持像素和百分比
  // outerRadius: "100%", // 外半径配置 支持像素和百分比
  // startAngle: 0, // 开始角度配置
  // endAngle: 180, // 结束角度配置
  // centerX: 300, // 中心X坐标配置
  // centerY: 300, // 中心Y坐标配置
